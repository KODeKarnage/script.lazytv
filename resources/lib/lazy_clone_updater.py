...
def Main():
    try:
        ...
        shutil.copytree(
            src_path, new_path, ignore=shutil.ignore_patterns(*IGNORE_PATTERNS)
        )
        ...
        shutil.move(
            os.path.join(new_path, "resources", "settings_clone.xml"),
    ...
    py_files = [
        os.path.join(new_path, "resources", "lib", "lazy_showselector.py"),
        os.path.join(new_path, "resources", "lib", "lazy_playlistselector.py"),
        os.path.join(new_path, "resources", "lib", "lazy_clone_updater.py"),
    ]

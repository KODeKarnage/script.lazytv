...
class LazySettingsHandler(object):
    ...
    def apply_settings(self, delta_dict={}, first_run=False):
        ...
        self.log(
            "Apply_settings reached, delta_dict: {}, first_run: {}".format(
                delta_dict, first_run
            )
        )
        ...
        if not first_run:
            ...
            if new_rando_list != "Empty":
                ...
                items = [
                    {
                        "object": self.parent.Wrangler,
                        "args": {
                            "show": show,
                            "new_rando_list": new_rando_list,
                            "current_type": show.show_type,
                        },
                    }
                    for k, show in self.parent.show_store.iteritems()
                ]

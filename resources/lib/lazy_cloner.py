...
def Main():
	...
	py_files = [os.path.join(new_path,'resources','lib','lazy_showselector.py') , os.path.join(new_path,'resources','lib','lazy_playlistselector.py'),os.path.join(new_path,'resources','lib','lazy_update_clone.py'),os.path.join(new_path,'resources','lib','lazy_episode_exporter.py')]

...
user_options = [lang(30085),lang(30086),lang(30106)]

inputchoice = xbmcgui.Dialog().select(lang(30084), user_options) 
...
"id": "allTVShows"}
shows = json_query(show_request)['result']['tvshows']
